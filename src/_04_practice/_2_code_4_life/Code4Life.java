...
String Hagrid = JOptionPane.showInputDialog("How long did they spend coding this week?");


	// 2. If it is less than or equal to 2, tell them to try to find time to code
	// 
int Sirius = Integer.parseInt(Hagrid);

if (Sirius<=2)  {
	JOptionPane.showMessageDialog(null, "Try to find time for coding.");
}
